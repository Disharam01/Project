    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="img/wqw.jpg" />
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div data-p="170.00">
                <img data-u="image" src="img/school.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/school.jpg" />
                    <span class="ti">School Campus</span><br />
                 
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/admin.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/admin.jpg" />
                    <span class="ti">Administrator</span><br />
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/students.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/students.jpg" />
                    <span class="ti">Students</span>
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/fees.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/fees.jpg" />
                    <span class="ti">Fees</span>
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/class.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/class.jpg" />
                    <span class="ti">Classrooms</span>
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/hostel.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/hostel.jpg" />
                    <span class="ti">School hostel</span><br />
                </div>
            </div>
           
            <div data-p="170.00">
                <img data-u="image" src="img/notice.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/notice.jpg" />
                    <span class="ti">Notices</span><br />
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/event.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/event.jpg" />
                    <span class="ti">Events</span><br />
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/teacher.png" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/teacher.png" />
                    <span class="ti">Teachers</span><br />
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="img/subject.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="img/subject.jpg" />
                    <span class="ti">Subjects</span><br />
                </div>
            </div>
